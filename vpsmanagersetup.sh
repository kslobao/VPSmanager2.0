...
if [ -d "/etc/squid3/" ]
then
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/squid2.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid3/squid.conf
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/payload.txt -O /etc/squid3/payload.txt
	echo " " >> /etc/squid3/payload.txt
	grep -v "^Port 443" /etc/ssh/sshd_config > /tmp/ssh && mv /tmp/ssh /etc/ssh/sshd_config
	echo "Port 443" >> /etc/ssh/sshd_config
	grep -v "^PasswordAuthentication yes" /etc/ssh/sshd_config > /tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
	echo "PasswordAuthentication yes" >> /etc/ssh/sshd_config
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/addhost.sh -O /bin/addhost
	chmod +x /bin/addhost
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/alterarsenha.sh -O /bin/alterarsenha
	chmod +x /bin/alterarsenha
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/criarusuario2.sh -O /bin/criarusuario
	chmod +x /bin/criarusuario
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/delhost.sh -O /bin/delhost
	chmod +x /bin/delhost
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/expcleaner2.sh -O /bin/expcleaner
	chmod +x /bin/expcleaner
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/mudardata.sh -O /bin/mudardata
	chmod +x /bin/mudardata
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/remover.sh -O /bin/remover
	chmod +x /bin/remover
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/sshlimiter2.sh -O /bin/sshlimiter
	chmod +x /bin/sshlimiter
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/alterarlimite.sh -O /bin/alterarlimite
	chmod +x /bin/alterarlimite
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/ajuda.sh -O /bin/ajuda
	chmod +x /bin/ajuda
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/sshmonitor2.sh -O /bin/sshmonitor
...
then
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/squid1.txt -O /tmp/sqd1
	echo "acl url3 dstdomain -i $ipdovps" > /tmp/sqd2
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/squid.txt -O /tmp/sqd3
	cat /tmp/sqd1 /tmp/sqd2 /tmp/sqd3 > /etc/squid/squid.conf
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/payload.txt -O /etc/squid/payload.txt
	echo " " >> /etc/squid/payload.txt
	grep -v "^Port 443" /etc/ssh/sshd_config > /tmp/ssh && mv /tmp/ssh /etc/ssh/sshd_config
	echo "Port 443" >> /etc/ssh/sshd_config
	grep -v "^PasswordAuthentication yes" /etc/ssh/sshd_config > /tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
	echo "PasswordAuthentication yes" >> /etc/ssh/sshd_config
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/2/addhost.sh -O /bin/addhost
	chmod +x /bin/addhost
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/alterarsenha.sh -O /bin/alterarsenha
	chmod +x /bin/alterarsenha
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/criarusuario2.sh -O /bin/criarusuario
	chmod +x /bin/criarusuario
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/2/delhost.sh -O /bin/delhost
	chmod +x /bin/delhost
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/expcleaner2.sh -O /bin/expcleaner
	chmod +x /bin/expcleaner
	wget http://www.ghostbrasil.com.br/wp/wp-content/VPSManager2.0/scripts/mudardata.sh -O /bin/mudardata
